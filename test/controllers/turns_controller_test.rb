...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post turns_url, params: { turn: { adjective: @turn.adjective, adverb: @turn.adverb, noun: @turn.noun, verb: @turn.verb } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { adjective: @turn.adjective, adverb: @turn.adverb, noun: @turn.noun, verb: @turn.verb } }
